            ...
            <div class="select-container">
                <table>
                    <tbody>
                        ...
                        <td class="select"><button id="exit" class="now">회원 탈퇴</button></td>
                    </tbody>
                </table>
            </div>
            	...
            	<div class="row">
            		<div class="profile">
	                    <c:if test="${memberDto.profile=='pic.jpg'}">
							<img class="img-circle" src="${root}/member/image?name=${memberDto.profile}" width="70" height="70" id="profile">
						</c:if>
						<c:if test="${memberDto.profile!='pic.jpg'}">
							<img class="img-circle" src="${root}/member/image?name=${memberDto.id}_${memberDto.profile}" width="70" height="70" id="profile">
						</c:if>
					</div>
					<div class="content">
						<div class="empty"></div>
