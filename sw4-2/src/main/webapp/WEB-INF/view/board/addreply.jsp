...
<c:set var="flag" value="${false}"></c:set>
			<c:forEach var="replyDto" items="${replyList}">
				<p class="reply-text"><c:if test="${replyDto.gno != 0 }">&nbsp;&nbsp;&nbsp;&nbsp;</c:if>${replyDto.id} | ${replyDto.content}</p><img class="reply-love" src="${root}/res/image/outLineHeart.png"width="17px" height="17px">
				<br>
				<p>
